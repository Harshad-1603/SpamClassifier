...
def sms():
    ...
    if lab[a]=='spam':
        classification = Label(root, text=res, font=('helvetica', 20 , 'bold'),fg="white" ,bg="red",width=30)
        classification.pack()
        classification.place(relx=0,rely=0.7)
    else:
        classification = Label(root, text=res, font=('helvetica', 20, 'bold'), fg="white" ,bg="green",width=30)
        classification.pack()
        classification.place(relx=0,rely=0.7)
...
my_bg.place(x=0,y=0,relheight=1,relwidth=1)

head = Label(root, text='Harshads SPAM-CHECKER',font=('helvetica', 24 , 'bold'),bg='blue',fg='white')
head.pack()
head.place(relx=0.1,rely=0.1)
e = Entry(root, width=400,borderwidth=5,fg='blue',font=24)
e.pack()
e.place(relx=0,rely=0.3)
b = Button(root, text = 'Check', font=('helvetica', 20 , 'bold'), fg = 'white', bg = 'green', command = sms)
b.pack()
b.place(relx=0.38,rely=0.5)
root.mainloop()
